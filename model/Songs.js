...
var temp = [];
const song_coll = collection(db,"songs_react");
const unsubscribe = onSnapshot(song_coll,(querySnapshot)=>{
  const songs_lst = [];
  querySnapshot.forEach((doc)=>{
    ...
    songs_lst.push(payload);
    temp.push(payload);
  });
  console.log("From firebase "+ songs_lst.length+" songs");
  // song_lst
  console.log("Song_lst: "+songs_lst);
})
console.log("temp: ");
console.log(temp);
